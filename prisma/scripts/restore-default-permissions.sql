-- If you run 'prisma migrate dev --name init' multiple times,
-- it sometimes asks if you want to recreate the whole schema.
-- If you chose yes, it will delete the public schema and recreate it.
-- The default grants are missing after this.
--
-- If you run into this problem, use thi helper SQL for fixing the grants:
-- Supabase SQL-query editor/runner: https://app.supabase.com/project/aoroupfmhgwjnmeylpxo/sql
